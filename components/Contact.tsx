            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-text-default">Adres</h4>
                    <p className="text-text-default mt-1">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <h4 className="font-semibold text-text-default">Telefon</h4>
                    <a href="tel:+902244441234" className="text-accent hover:text-accent/80 transition-colors">
                      +90 (224) 444 12 34
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <h4 className="font-semibold text-text-default">E-posta</h4>
                    <a href="mailto:info@vizyonex.com" className="text-accent hover:text-accent/80 transition-colors">
                      info@vizyonex.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <h4 className="font-semibold text-text-default">Web Sitesi</h4>
                    <a href="https://www.vizyonex.com" target="_blank" rel="noopener noreferrer" className="text-accent hover:text-accent/80 transition-colors">
                      www.vizyonex.com
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  <span className="font-medium text-text-default">Pazartesi - Cuma</span>
                  <span className="text-accent font-semibold">08:00 - 18:00</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-100">
                  <span className="font-medium text-text-default">Cumartesi</span>
                  <span className="text-accent font-semibold">09:00 - 16:00</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="font-medium text-text-default">Pazar</span>
              ...
              <div className="mt-6 p-4 bg-accent/10 rounded-lg">
                <p className="text-sm text-text-default">
                  ...
                  Acil durumlar için: 
                  <a href="tel:+905321234567" className="text-accent font-semibold ml-1">
                    +90 (532) 123 45 67
                  </a>
                </p>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="flex items-center justify-center w-12 h-12 bg-[#0077b5] text-white rounded-lg hover:bg-[#005885] transition-colors"
                  title="LinkedIn"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all"
                  title="Instagram"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-12 h-12 bg-[#25d366] text-white rounded-lg hover:bg-[#1da851] transition-colors"
                  title="WhatsApp"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-16">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h4 className="text-xl font-semibold text-text-default mb-4">
                  Bursa Organize Sanayi Bölgesi
                </h4>
                <p className="text-text-default leading-relaxed mb-4">
                ...
                <div className="flex items-start text-sm text-text-default">
                  <svg className="w-4 h-4 text-accent mt-1 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-gray-100 rounded-lg p-8 text-center">
                ...
                <div className="w-full h-64 bg-gray-200 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-500 font-medium">Harita Yakında Eklenecek</p>
                    <p className="text-gray-400 text-sm mt-1">Google Maps entegrasyonu</p>
                  </div>
                </div>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center mt-4 px-6 py-2 bg-accent text-text-light rounded-lg hover:bg-accent/90 transition-colors"
                >
