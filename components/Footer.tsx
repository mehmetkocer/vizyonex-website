          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+905524251381" className="text-text-light/80 hover:text-accent transition-colors text-sm">
                  +90 (552) 425 13 81
                </a>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@vizyonexyapi.com" className="text-text-light/80 hover:text-accent transition-colors text-sm">
